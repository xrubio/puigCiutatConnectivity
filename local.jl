...
# cost
run(`gdal_translate -of AAIGrid -tr 30 30 -a_srs epsg:25831 data/base/cost_local_30m_crit8.tif tmp/cost_local_30m_crit8.asc`)
# points
...
run(`gdal_translate -of AAIGrid -ot Int32 -tr 30 30 -a_srs epsg:25831 tmp/points.tif tmp/points.asc`)
...
run(`gdal_translate -of GTiff -ot Float64 -tr 30 30 -a_srs epsg:25831 tmp/local_cum_curmap.asc output/local/local_cur.tif`)
