...
run(`gdal_translate -of AAIGrid -ot Int32 -tr 100 100 -a_srs epsg:25831 tmp/massalia.tif tmp/massalia.asc`)
run(`gdal_translate -of AAIGrid -ot Int32 -tr 100 100 -a_srs epsg:25831 tmp/tarraco.tif tmp/tarraco.asc`)
run(`gdal_translate -of AAIGrid -ot Int32 -tr 100 100 -a_srs epsg:25831 tmp/emporion.tif tmp/emporion.asc`)
run(`gdal_translate -of AAIGrid -ot Int32 -tr 100 100 -a_srs epsg:25831 tmp/ilerda.tif tmp/ilerda.asc`)
# transform geotiff raster maps for friction surface to ASC with GDAL
run(`gdal_translate -of AAIGrid -ot Float64 -tr 100 100 -a_srs epsg:25831 data/base/cost_100m_crit8.tif tmp/cost_100m_crit8.asc`)
...
run(`gdal_translate -of GTiff -ot Float64 -tr 100 100 -a_srs epsg:25831 tmp/massalia_curmap.asc output/campaign/massalia_cur.tif`)
run(`gdal_translate -of GTiff -ot Float64 -tr 100 100 -a_srs epsg:25831 tmp/tarraco_curmap.asc output/campaign/tarraco_cur.tif`)
run(`gdal_translate -of GTiff -ot Float64 -tr 100 100 -a_srs epsg:25831 tmp/emporion_curmap.asc output/campaign/emporion_cur.tif`)
